...
smiles          : (chain?) | /* explicitly handle case where the entire smile is enclosed in parenthesis*/ ('(' chain ')')?;
...
atom            : ('[' isotope? symbol chiral? hcount? charge? atomclass? ']') | organic | aromatic | halogen;
